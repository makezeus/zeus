...
class Mine extends CI_Controller {
    ...
    public function login(){
        ...
        $this->form_validation->set_rules('emailCliente','Email','valid_email|required|trim');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->db->where('emailCliente',$emailCliente);
	...
	public function visualizarOs($id = null){
        ...
        $data['emitente'] = $this->ZeusModel->getEmitente();
