...
class Os extends CI_Controller
{
    function __construct()
    {
        ...
        $this->data['menuOs'] = 'Ordens de Serviços';
    }
    ...
    function gerenciar()
    {
        ...
        $this->data['results'] = $this->os_model->getOs('os', 'idOs,dataInicial,dataFinal,garantia,descricaoProduto,defeito,status,observacoes,laudoTecnico,valorTotal', $where_array, 10, $this->uri->segment(3));
    ...
    function adicionarCliente()
    {
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            if ($this->clientes_model->add('clientes', $data) == TRUE) {
                ...
                redirect(base_url() . 'os/adicionar/');
            } else {
    ...
    public function adicionarServico()
    {
        ...
        $quantidade = $this->input->post('quantidadeser');
        $subtotal = $preco * $quantidade;
        $data = array(
            'subTotalSer' => $subtotal,
            'quantidadeSer' => $quantidade,
