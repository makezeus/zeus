...
<div class="visible-phone" id="headermobile">Ordens de Serviços</div>
...
<?php } else { ?>
    ...
    <div class="panel">
        <div class="panel-heading">
            ...
            <form method="get" style="display: flex; justify-content:space-between" action="<?php echo base_url(); ?>/os/gerenciar">

                <div class="form-group" style="">
                    <input type="text" name="pesquisa" style="margin-bottom: 0px" id="pesquisa" placeholder="Nome do Cliente" class="form-control" value="">
                </div>
                ...
                <div style="display:flex; gap: 8px">
                    ...
                    <div class="form-group" style="">
                        <input type="text" name="data" id="data" placeholder="Data Inicial" style="margin-bottom: 0px" class="form-control" value="">
                    </div>

                    <div class="form-group" style="">
                        <input type="text" name="data2" id="data2" placeholder="Data Final" style="margin-bottom: 0px" class="form-control" value="">
                    </div>
                        ...
                        <tr>
                            <td>
                                <div style="display: flex; flex-direction:column">
                                    <span><? echo $r->nomeCliente ?></span>
                                    <span style="font-size: 0.75rem; color: #6B7280"><? echo $r->nome ?></span>
                                </div>
                            </td>

                            <td><? echo date("d/m/Y", strtotime($r->dataInicial)); ?></td>
                            <td><? echo date("d/m/Y", strtotime($r->dataFinal)); ?></td>

                            <td class="hidden-xs"><? echo statusMapperBudget($r->status) ?> </td>

                            <td>R$ <? echo number_format($r->valorTotal, 2, ',', '.') ?></td>
    ...
    <div class="" style="clear: both;"><?php echo $this->pagination->create_links();
                                    } ?></div>
