            ...
            <div class="widget-title">
                ...
                <div class="buttons">
                    <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'eOs')){
                        echo '<a title="Icon Title" class="btn btn-mini btn-info" href="'.base_url().'os/editar/'.$result->idOs.'"><i class="icon-pencil icon-white"></i> Editar</a>'; 
                    } ?>
                    ...
                    <div class="invoice-head" style="margin-bottom: 0">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>zeus/emitente">Configurar</a><<<</td>
                                </tr>
                                <?php } else {?>
                                <tr>
