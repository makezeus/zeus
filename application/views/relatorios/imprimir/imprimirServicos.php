...
$precoInicial = number_format( $this->input->get('precoInicial'), 2, ',', '.');
$precoFinal = number_format( $this->input->get('precoFinal'), 2, ',', '.');
...
$html = '
                          <h4 style="text-align: center"><strong>RELATÓRIO DE SERVIÇOS '.$acao.'</strong></h4>
                  ...
                  <table border="1" cellpadding="5" >
                            ...
                            <tr>
                              <th style="font-size: 1.2em; padding: 5px;"><strong>Nome</strong></th>
                              <th style="font-size: 1.2em; padding: 5px;"><strong>Descrição</strong></th>
                              <th style="font-size: 1.2em; padding: 5px;"><strong>Preço</strong></th>
                          </tr>
                   ';
 ...
 foreach ($servicos as $s) {
                              $html .=  '
                              <tr>
                              <td>' . strtoupper($s->nome). '</td>
                              <td>' . strtoupper($s->descricao). '</td>
