                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on"><i class="icon-user"></i></span><input id="emailCliente" name="emailCliente" type="text" placeholder="Email" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on"><i class="icon-star"></i></span><input class="cpf" name="documento" type="text" placeholder="CPF" />
                        </div>
                    </div>
                </div>
      ...
      <script src="<?php echo base_url()?>assets/js/jquery.validate.js"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#formLogin").validate({
                     rules :{
                          emailCliente: { required: true, emailCliente: true},
                          senha: { required: true}
                    },
                    messages:{
                          emailCliente: { required: 'Campo Requerido.', emailCliente: 'Insira Email válido'},
