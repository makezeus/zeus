<div class="widget-box">
    <div class="widget-title">
        <ul class="nav nav-tabs">
            ...
            <div class="buttons">
                    <a title="Icon Title" class="btn btn-mini btn-info" href="<?php echo base_url()?>mine/editarDados/<?php echo $result->idClientes?>"><i class="icon-pencil icon-white"></i> Editar</a>
                </div>
        </ul>
    </div>
