            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="telefone" type="text" name="telefone" value="<?php echo $result->telefoneCliente; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="email" type="text" name="email" value="<?php echo $result->emailCliente; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3">
                                ...
                                <a href="<?php echo base_url() ?>mine/conta" id="" class="btn"><i class="icon-arrow-left"></i> Voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
